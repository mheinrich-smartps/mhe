...
/**
 ...
 function getParamByStepId(id, name) {
  ...
  var iterator = myDoc.evaluate("//Object[@id='" + id + "']/Field[@Name='" + name + "']", myDoc, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null);
  console.log("StepID: " + id + " Name: " + name + "Value: " + iterator.singleNodeValue.textContent);
